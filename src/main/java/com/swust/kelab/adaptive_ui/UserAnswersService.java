...
public class UserAnswersService {
	 ...
	 @Value("${my_services_uri.GET_USERANSWERS_URI}")
	    private String GET_USERANSWERS_URI;
	    
	 @Value("${my_services_uri.DELETE_USERANSWERS_URI}")
	 private String DELETE_USERANSWERS_URI;
	    ...
	    public Result getAll(HttpServletRequest request){
	        ...
	        if(accessToken != null){
	            ...
	            params.setUri(GET_USERANSWERS_URI);
	    ...
	    public Result delete(String ids, HttpServletRequest request) {
	        ...
	        if(accessToken != null){
	            //初始化参数
	            Params params = new Params();
	            params.setUri(DELETE_USERANSWERS_URI);
